    ...
    <article className="mt-24 max-w-3xl mx-auto py-10 px-4">
      ...
      <section className="prose prose-lg max-w-none text-gray-800 mb-6">
        ...
        <ol className="space-y-1">
          ...
          <li>Continuing your WellFed journey </li>
        </ol>
      ...
      <footer className="mt-10">
        ...
        <ul className="list-disc list-inside mt-4 text-gray-700">
          <li>
            ...
            <Link href="https://my.clevelandclinic.org/health/body/25177-ketones" target="_blank" rel="noopener noreferrer">
          ...
          <li>
            ...
            <Link href="https://health.clevelandclinic.org/what-is-the-keto-diet-and-should-you-try-it" target="_blank" rel="noopener noreferrer">
          ...
          <li>
            ...
            <Link href="https://www.health.harvard.edu/staying-healthy/should-you-try-the-keto-diet" target="_blank" rel="noopener noreferrer">
          ...
          <li>
            ...
            <em>Delish.com</em>.
            <Link href="https://www.delish.com/cooking/recipe-ideas/a30707105/keto-beef-stroganoff-recipe/" target="_blank" rel="noopener noreferrer">
